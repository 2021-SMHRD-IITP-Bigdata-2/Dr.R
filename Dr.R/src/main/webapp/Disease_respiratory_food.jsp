...
<body>
    ...
    <div>
        <ul style="text-align: center;">
            <a class="test_font1" style="font-size: 17px; " href="Disease_respiratory.html">정보</a>
            &nbsp&nbsp
            &nbsp&nbsp

            <a class="test_font1" style="font-size: 17px;border-bottom: 2px solid #adadad;" href="Disease_respiratory_food.jsp">식재료</a>
                &nbsp&nbsp
            &nbsp&nbsp

            <a class="test_font1" style="font-size: 17px;" href="Disease_respiratory_recipe.html">레시피</a>
        </ul>
    ...
    <section class="small-receipe-area" >
        <div class="container">
            ...
            <div align="center" class="test_font" style="font-size: 25px; font-weight: bold;">
                <span style="color: brown;">호흡기질환<span style="color: black;">에 좋은 레시피에요!</span></span>
            </div>
