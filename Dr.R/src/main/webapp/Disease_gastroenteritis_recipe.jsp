...
<%
	...
	food = dao.food_we();
	// food.get(0).getFood_image();
	
	// 이거 불러오기만 하면 dto에 저장됨
...
<body>
    ...
    <div>
        <ul style="text-align: center; ">
            ...
            &nbsp&nbsp
            <a class="test_font" style="font-size: 20px;  border-bottom: 2px solid #adadad;" href="Disease_gastroenteritis.html">위장병</a>
        </ul>
    </div>
    <br>
    <div>
        <ul style="text-align: center;">
            ...
            <a class="test_font1" style="font-size: 17px;border-bottom: 2px solid #adadad;" href="Disease_Diabetes_recipe.html">관련
                레시피</a>
        </ul>
    ...
    <section class="small-receipe-area" >
        <div class="container">
            ...
            <div align="center" class="test_font" style="font-size: 25px; font-weight: bold;">
                <span style="color: brown;">위장병<span style="color: black;">에 좋은 레시피에요!</span></span>
            </div>
