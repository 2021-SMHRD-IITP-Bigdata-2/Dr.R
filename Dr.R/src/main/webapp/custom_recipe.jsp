...
<body>
    ...
    <div>
        <ul style="text-align: center; ">
            <a class="test_font" style="font-size: 30px;" href="custom_ingredient.html">식재료</a>
            &nbsp&nbsp
            <a class="test_font" style="font-size: 30px; border-bottom: 2px solid #adadad;" href="custom_recipe.html">레시피</a>
        </ul>
    </div>
    <br>
    </div>
    ...
    <br>
    <br>
       <h5 class="test_font" align="center" style="font-size: 25px; margin-top: 20px;">도훈
